...
<head>
    ...
    <title>@yield('title', 'Guest Dashboard') - Sistem Persil</title>
...
<body class="bg-gray-100">
    ...
    <div class="flex h-screen">
        ...
        <div class="sidebar w-64 bg-blue-900 text-white p-6 overflow-y-auto" id="sidebar">
            <!-- Mobile Close Button -->
            ...
            <div class="mb-8 mt-8 lg:mt-0">
                ...
                <p class="text-blue-200 text-sm">Guest Panel</p>
            </div>

            <!-- Navigation Menu -->
            <nav class="space-y-2">
                <a href="{{ route('guest.dashboard') }}" class="flex items-center space-x-3 px-4 py-3 rounded font-medium text-base {{ request()->routeIs('guest.dashboard') ? 'bg-blue-600' : 'hover:bg-blue-800' }} transition">
            ...
            <div class="mt-8 pt-8 border-t border-blue-700">
                <form action="{{ route('logout') }}" method="POST" id="logoutForm">
                    @csrf
                    <button type="button" class="flex items-center space-x-3 px-4 py-3 rounded w-full hover:bg-blue-800 font-medium text-base transition" onclick="confirmLogout()">
