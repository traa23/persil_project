...
@section('title', 'Tambah User - Sistem Informasi Persil')
        ...
        <div class="form-container">
            <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="user-form">
                ...
                <div class="form-group">
                    ...
                    <div class="file-upload-wrapper">
                        ...
                        <div class="file-upload-info">
                            ...
                            <span class="file-text">Pilih foto profil (Opsional)</span>
                ...
                <div class="form-actions">
                    <button type="submit" class="button special">Simpan Data</button>
...
function removeImage() {
    ...
    fileInfo.querySelector('.file-text').textContent = 'Pilih foto profil (Opsional)';
}
</script>
@endsection
