...
@section('title', 'Edit Persil')
@section('page-title', 'Edit Data Persil')
    ...
    <form action="{{ getAdminRoute('persil.update', $persil->persil_id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative" id="jenisPenggunaanContainer">
                    ...
                    <input
                        ...
                        value="{{ old('jenis_penggunaan_custom', $persil->jenisPenggunaan->nama_penggunaan ?? '') }}"
        ...
        <div>
            ...
            <textarea
                ...
                required
            >{{ old('alamat_lahan', $persil->alamat_lahan) }}</textarea>
            @error('alamat_lahan')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
            @enderror
        </div>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">
                Foto Persil Saat Ini
            </label>
            @if ($persil->fotoPersil->count() > 0)
                <div class="mb-4">
                    <p class="text-sm text-gray-600 mb-2">{{ $persil->fotoPersil->count() }} foto</p>
            ...
            @else
                <p class="text-gray-500 text-sm mb-4">Belum ada foto</p>
            @endif
