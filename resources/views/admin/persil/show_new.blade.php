        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    @if($persil->pemilik && $persil->pemilik->photo_path && \Storage::disk('public')->exists($persil->pemilik->photo_path))
                        <div style="margin-top: 10px;">
                            <img src="{{ asset('storage/' . $persil->pemilik->photo_path) }}" alt="Profile Photo" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; border: 2px solid #ddd;">
                        </div>
                    @endif
                </div>
            </div>
